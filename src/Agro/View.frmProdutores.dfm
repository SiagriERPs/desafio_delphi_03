object frmProdutores: TfrmProdutores
  ...
  object pcLista: TPageControl
    ...
    object tsCadastro: TTabSheet
      ...
      object dbgLimite: TDBGrid
        ...
        Width = 422
        Height = 177
        Hint = 'Informe o limite de cr'#233'dito para cada Distribuidor.'
        Color = clBtnHighlight
        DataSource = dsLimite
        DrawingStyle = gdsGradient
      ...
      object bbLimiteRefresh: TBitBtn
        Left = 447
        Top = 192
        Width = 98
        Height = 30
  ...
  object cdsLista: TClientDataSet
    ...
    object cdsListaCPF_CNPJ: TStringField
      FieldName = 'CPF_CNPJ'
      Origin = 'CPF_CNPJ'
      Size = 14
    end
  ...
  object qyLimite: TFDQuery
    Connection = DM.conexao
    SQL.Strings = (
      'SELECT * FROM PRODUTOR_LIMITE WHERE PRODUTORID = :PRODUTORID ')
    Left = 440
    Top = 176
    ParamData = <
      item
  ...
  object cdsLimite: TClientDataSet
    ...
    Left = 575
    Top = 176
    object cdsLimiteID: TIntegerField
      FieldName = 'ID'
      Origin = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cdsLimitePRODUTORID: TIntegerField
      FieldName = 'PRODUTORID'
      Origin = 'PRODUTORID'
    end
    object cdsLimiteDISTRIBUIDORID: TIntegerField
      FieldName = 'DISTRIBUIDORID'
      Origin = 'DISTRIBUIDORID'
    end
    object cdsLimiteLIMITE: TFMTBCDField
      FieldName = 'LIMITE'
      Origin = 'LIMITE'
      DisplayFormat = '0.00'
      EditFormat = '0.00'
    ...
    object cdsLimiteDISTRIBUIDOR: TStringField
      FieldKind = fkLookup
      FieldName = 'DISTRIBUIDOR'
